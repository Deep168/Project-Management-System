	...
	<div class="container">
		...
		<div class="center">
			...
			<form  method="POST">
              ...
              <div class="inputbox">
				<input type="text" name="assignedto" required="required">
		...
		$query = "INSERT INTO `task`(`title`, `description`, `starttime`, `endtime`, `status`, `assignedto`) VALUES ('$title','$decription','$starttime','$endtime','$status','$assignedto')";
